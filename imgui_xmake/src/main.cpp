...
// Your own project should not bQe affected, as you are likely to link with a newer binary of GLFW that is adequate for your version of Visual Studio.
...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(200, 1, "zutil", NULL, NULL);
    if (window == NULL)
        return 1;
