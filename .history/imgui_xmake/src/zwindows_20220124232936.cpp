 ...
 * @LastEditTime: 2022-01-24 23:29:36
...
void main_window()
{
    ...
    if(show_main_window)
    {
        ImGui::Begin("zutil", &show_main_window, ImGuiWindowFlags_AlwaysAutoResize);  
    ...
    if(show_uart_window)
    {
        ...
        ImGui::Begin("uart", &show_uart_window, ImGuiWindowFlags_AlwaysAutoResize);  
